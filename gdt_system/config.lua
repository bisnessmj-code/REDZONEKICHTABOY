...
Config.LobbyLocation = vector3(-1437.837402, -2813.366943, 430.928955)
...
Config.TeamZones = {
    red = {
        coords = vector3(-1456.879150, -2806.575928, 431.114258),
        color = {r = 0, g = 0, b = 0, a = 200},
        radius = 2.0,
        label = "équipe Rouge"
    },
    blue = {
        coords = vector3(-1422.606567, -2826.461426, 431.114258),
